var emailLabel = document.getElementById("registerEmailLabel"),
    ...
    namaLabel = document.getElementById("registerNamaLabel"),
    nama = document.querySelector("#nama"),
    passwordLabel = document.getElementById("registerPasswordLabel"),
    password = document.querySelector("#password"),
    confirmPasswordLabel = document.getElementById("confirmRegisterPasswordLabel"),
...
function onEmailBlur(e) {
    activeElement = null;
    setTimeout(() => {
        if (!activeElement && e.target.value === "") {
...
function onPasswordFocus(e) {
    // console.log("Fokus di Password → Cover Eyes");
    activeElement = "password";
    coverEyes();
}

function onConfirmPasswordFocus(e) {
    // console.log("Fokus di Confirm Password → Spread Fingers");
    activeElement = "confirm_password";
    if(!coverEyes()){
        spreadFingers()
    }
}
...
function onPasswordBlur(e) {
    setTimeout(() => {
        // console.log("Blur dari Password, activeElement:", activeElement);
        if (activeElement !== "confirm_password") {
            // console.log("Pindah ke Field Lain → Uncover Eyes");
            uncoverEyes(); // Buka mata jika tidak pindah ke confirm password
        } else{
            // console.log("Pindah ke Confirm Password → Spread Fingers");
            coverEyes();
        }
    }, 100);
}
...
function onConfirmPasswordBlur(e) {
    setTimeout(() => {
        // console.log("Blur dari Confirm Password, activeElement:", activeElement);
        if (activeElement !== "password") {
            // console.log("Pindah ke Field Lain → Uncover Eyes");
            closeFingers();
            uncoverEyes(); // Buka mata jika tidak kembali ke password
        } else {
            // console.log("Pindah ke Password → Cover Eyes");
            closeFingers(); // Pastikan tetap cover eyes jika kembali ke password
        }
    }, 100);
}
