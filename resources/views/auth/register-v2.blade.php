...
<body>
    <div class="form">
        ...
        <form id="registerForm" action="{{ route('register') }}" method="POST">
            ...
            <div class="inputGroup inputGroup2">
                <label for="confirmRegisterPassword" id="confirmRegisterPasswordLabel">Confirm Password</label>
                <input type="password" id="confirm_password" name="confirm_password" required />
            </div>
            <div class="inputGroup inputGroup3">
                <button type="submit" id="register">Register</button>
                <label style="margin-top: 12px; font-size: small; text-align: center;">Sudah mempunyai akun ? Silakan <a href="{{route('login')}}">Login</a></label>
            </div>
        </form>
    </div>
