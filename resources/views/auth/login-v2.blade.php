    ...
    <div class="form">
        ...
        <form id="loginForm" action="{{ route('login') }}" method="POST">
            ...
            <div class="inputGroup inputGroup2">
                ...
                <label id="showPasswordToggle" for="showPasswordCheck" style="margin-top: 12px; font-size: small;">
                    <input id="showPasswordCheck" type="checkbox" /> Show password
                </label>
            </div>
            <div class="inputGroup inputGroup3">
                <button type="submit" id="login">Log in</button>
                <label style="margin-top: 12px; font-size: small; text-align: center;">Belum mempunyai akun ? <a href="{{route('register')}}">Register</a></label>
            </div>
        </form>
    </div>
    <script src="{{asset('assets/compiled/js/login.js')}}"></script>
